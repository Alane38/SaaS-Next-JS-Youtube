    ...
    <Card>
      <form action={updateNote}>
        ...
        <CardHeader>
          ...
          <CardDescription>
            Modifier votre note puis sauvegarder
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-y-5">
          ...
          <div className="gap-y-2 flex flex-col">
            ...
            <Input
              ...
              className="w-6 cursor-pointer accent-orange-500"
              type="checkbox"
              name="completed"
              id="completed"
            />
        ...
        <CardFooter className="flex items-center justify-between">
          ...
          <Button className="bg-orange-500 mx-1 my-2 hover:bg-orange-600 text-white">
            Modifier
          </Button>
        </CardFooter>
      </form>
